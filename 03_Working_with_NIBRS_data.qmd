...
# Create the table
kable(df, escape = FALSE, col.names = c("Code", "Description")) |>
...
6. `r .exerciseQuestions[6]` To examine trends we would need to load several years of NIBRS data. For now, let's just calculate the number of retail theft (23C) incidents reported to agencies that reported 12 months of NIBRS data.
```{r}
#| comment: ""
#| cache: true
nibrsCrm02 |>
