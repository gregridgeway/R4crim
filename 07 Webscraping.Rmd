---
title: "Webscraping and Parallel Implementation"
author: "XXXXXX"
...
In the html code, search for a movie name that appears on the webpage. Start with "The Purge: Election Year" as an example. That occurs on line 255 of the html code. We're trying to look for a pattern of characters and/or letters that always precedes any movie name in the html code.  Try another movie name such as "X Men: Apocalypse." That occurs on line 363 of the html code. In both instances, we can conclue that "movie" seems to precede each movie name in the html code. 
