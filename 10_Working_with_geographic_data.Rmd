...
```
Here we have requested populationa data (variable `B00001_001E`) for two specific census tracts (204920 and 205110)  from California (state 06) in Los Angeles County (county 037).

If we want the total population in all tracts in Los Angeles County, just change the tract list to an *.
```{r comment="", results='hold'}
