...
ucr[i,]
```
Note what the i (indexing variable) does - it is a list of the row numbers in the ucr dataframe that have "NEW YORK" somewhere in the agency column. As you can see, there are 4 agencies that have "New York" in their name. 
